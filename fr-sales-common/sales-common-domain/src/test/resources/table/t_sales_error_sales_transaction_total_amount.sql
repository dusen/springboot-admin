DROP TABLE IF EXISTS sales-dev6.t_sales_error_sales_transaction_total_amount CASCADE;
CREATE TABLE sales-dev6.t_sales_error_sales_transaction_total_amount(
