DROP TABLE IF EXISTS sales-dev6.t_transaction_inquiry_sales_transaction_total_amount CASCADE;
CREATE TABLE sales-dev6.t_transaction_inquiry_sales_transaction_total_amount(
