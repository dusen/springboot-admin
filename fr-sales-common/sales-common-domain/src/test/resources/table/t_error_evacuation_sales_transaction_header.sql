DROP TABLE IF EXISTS sales-dev6.t_error_evacuation_sales_transaction_header CASCADE;
CREATE TABLE sales-dev6.t_error_evacuation_sales_transaction_header(
...
;
 CREATE INDEX t_error_evacuation_sales_transaction_header_KEY1 ON sales-dev6.t_error_evacuation_sales_transaction_header(sales_transaction_error_id);
