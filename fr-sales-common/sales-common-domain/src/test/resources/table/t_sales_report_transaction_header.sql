DROP TABLE IF EXISTS sales-dev6.t_sales_report_transaction_header CASCADE;
CREATE TABLE sales-dev6.t_sales_report_transaction_header(
...
;
 CREATE INDEX t_sales_report_transaction_header_KEY1 ON sales-dev6.t_sales_report_transaction_header(ims_linkage_flag,ims_linkage_date,store_code,update_datetime);
 CREATE INDEX t_sales_report_transaction_header_KEY2 ON sales-dev6.t_sales_report_transaction_header(transaction_summary_flag,ims_linkage_date,store_code,cash_register_no,update_datetime);
