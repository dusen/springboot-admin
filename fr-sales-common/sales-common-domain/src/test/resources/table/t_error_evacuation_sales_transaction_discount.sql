DROP TABLE IF EXISTS sales-dev6.t_error_evacuation_sales_transaction_discount CASCADE;
CREATE TABLE sales-dev6.t_error_evacuation_sales_transaction_discount(
...
;
 CREATE INDEX t_error_evacuation_sales_transaction_discount_KEY1 ON sales-dev6.t_error_evacuation_sales_transaction_discount(sales_transaction_error_id);
