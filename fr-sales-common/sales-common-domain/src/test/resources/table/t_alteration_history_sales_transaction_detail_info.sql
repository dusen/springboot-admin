DROP TABLE IF EXISTS sales-dev6.t_alteration_history_sales_transaction_detail_info CASCADE;
CREATE TABLE sales-dev6.t_alteration_history_sales_transaction_detail_info(
...
;
 CREATE INDEX t_alteration_history_sales_transaction_detail_info_KEY1 ON sales-dev6.t_alteration_history_sales_transaction_detail_info(sales_transaction_error_id);
