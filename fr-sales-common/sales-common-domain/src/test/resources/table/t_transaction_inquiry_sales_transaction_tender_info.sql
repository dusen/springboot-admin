DROP TABLE IF EXISTS sales-dev6.t_transaction_inquiry_sales_transaction_tender_info CASCADE;
CREATE TABLE sales-dev6.t_transaction_inquiry_sales_transaction_tender_info(
