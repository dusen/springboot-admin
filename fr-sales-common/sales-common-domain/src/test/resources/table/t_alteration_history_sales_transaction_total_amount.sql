DROP TABLE IF EXISTS sales-dev6.t_alteration_history_sales_transaction_total_amount CASCADE;
CREATE TABLE sales-dev6.t_alteration_history_sales_transaction_total_amount(
...
;
 CREATE INDEX t_alteration_history_sales_transaction_total_amount_KEY1 ON sales-dev6.t_alteration_history_sales_transaction_total_amount(sales_transaction_error_id);
