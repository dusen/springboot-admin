DROP TABLE IF EXISTS sales-dev6.t_error_evacuation_sales_order_information CASCADE;
CREATE TABLE sales-dev6.t_error_evacuation_sales_order_information(
...
;
 CREATE INDEX t_error_evacuation_sales_order_information_KEY1 ON sales-dev6.t_error_evacuation_sales_order_information(sales_transaction_error_id);
