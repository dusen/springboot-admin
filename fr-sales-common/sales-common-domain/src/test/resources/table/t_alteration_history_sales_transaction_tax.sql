DROP TABLE IF EXISTS sales-dev6.t_alteration_history_sales_transaction_tax CASCADE;
CREATE TABLE sales-dev6.t_alteration_history_sales_transaction_tax(
...
;
 CREATE INDEX t_alteration_history_sales_transaction_tax_KEY1 ON sales-dev6.t_alteration_history_sales_transaction_tax(sales_transaction_error_id);
