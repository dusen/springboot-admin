DROP TABLE IF EXISTS sales-dev6.t_ims_sales_transaction_header CASCADE;
CREATE TABLE sales-dev6.t_ims_sales_transaction_header(
...
;
 CREATE INDEX t_ims_sales_transaction_header_KEY1 ON sales-dev6.t_ims_sales_transaction_header(lot_number);
