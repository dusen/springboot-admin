DROP TABLE IF EXISTS sales-dev6.w_non_item CASCADE;
CREATE TABLE sales-dev6.w_non_item(
 ...
 update_program_id varchar(30),
  CONSTRAINT w_non_item_pk
   PRIMARY KEY(lot_number,system_country_code,system_brand_code,non_item_code,apply_start_date)
)
