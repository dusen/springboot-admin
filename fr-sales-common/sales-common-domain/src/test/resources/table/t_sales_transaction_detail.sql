DROP TABLE IF EXISTS sales-dev6.t_sales_transaction_detail CASCADE;
CREATE TABLE sales-dev6.t_sales_transaction_detail(
...
;
 CREATE INDEX t_sales_transaction_detail_KEY1 ON sales-dev6.t_sales_transaction_detail(sales_transaction_id,detail_sub_number);
