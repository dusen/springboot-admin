DROP TABLE IF EXISTS sales-dev6.t_alteration_history_sales_transaction_detail CASCADE;
CREATE TABLE sales-dev6.t_alteration_history_sales_transaction_detail(
...
;
 CREATE INDEX t_alteration_history_sales_transaction_detail_KEY1 ON sales-dev6.t_alteration_history_sales_transaction_detail(sales_transaction_error_id);
