DROP TABLE IF EXISTS sales-dev6.t_sales_error_sales_transaction_detail_info CASCADE;
CREATE TABLE sales-dev6.t_sales_error_sales_transaction_detail_info(
