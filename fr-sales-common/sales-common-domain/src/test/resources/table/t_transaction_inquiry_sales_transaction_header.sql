DROP TABLE IF EXISTS sales-dev6.t_transaction_inquiry_sales_transaction_header CASCADE;
CREATE TABLE sales-dev6.t_transaction_inquiry_sales_transaction_header(
...
;
 CREATE INDEX t_transaction_inquiry_sales_transaction_header_KEY1 ON sales-dev6.t_transaction_inquiry_sales_transaction_header(sales_transaction_id);
