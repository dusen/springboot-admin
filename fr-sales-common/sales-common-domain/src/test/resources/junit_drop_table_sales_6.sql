...
DROP TABLE IF EXISTS public.m_g_class;

DROP TABLE IF EXISTS public.w_g_class;
...
DROP TABLE IF EXISTS public.m_salesreport_item_setting;
...
DROP TABLE IF EXISTS public.t_sales_check_data;
...
DROP TABLE IF EXISTS public.w_store;
