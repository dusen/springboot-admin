...
public class StoreMasterMapperTest {

    @Autowired
    private StoreMasterMapper storeEntityMapper;

    @Test
    @DatabaseSetup("MStoreEntityMapperTest.xml")
    public void testSelectByPrimaryKeyOneRecord() {

        StoreMaster storeEntity = storeEntityMapper.selectByPrimaryKey("1");
        assertEquals(storeEntity.getStoreCode(), "1");
        assertEquals(storeEntity.getChannelId(), "1");
    ...
    public void testSelectByPrimaryKeyNoRecord() {
        ...
        StoreMaster storeEntity = storeEntityMapper.selectByPrimaryKey("5");
        assertEquals(storeEntity, null);
