 ...
 *
 */
public interface UpdateSalesCoreService {

    /**
     * Update transaction data to sales core table.
     * 
     ...
     */
    void updateSalesCoreTable(TransactionImportData transactionImportData, String userId,
