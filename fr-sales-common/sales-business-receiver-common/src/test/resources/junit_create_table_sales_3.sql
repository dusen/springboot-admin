DROP TABLE IF EXISTS t_dclose;
CREATE TABLE t_dclose(
...
DROP TABLE IF EXISTS w_dclose_send;
CREATE TABLE w_dclose_send(
...
DROP TABLE IF EXISTS t_ims_sales_transaction_detail;
CREATE TABLE t_ims_sales_transaction_detail(
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_sales_transaction_detail_KEY1 ON t_ims_sales_transaction_detail(lot_number);

DROP TABLE IF EXISTS t_ims_sales_transaction_discount;
CREATE TABLE t_ims_sales_transaction_discount(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_sales_transaction_discount_KEY1 ON t_ims_sales_transaction_discount(lot_number);

DROP TABLE IF EXISTS t_ims_sales_transaction_header;
CREATE TABLE t_ims_sales_transaction_header(
 sales_transaction_id varchar(30) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_sales_transaction_header_KEY1 ON t_ims_sales_transaction_header(lot_number);

DROP TABLE IF EXISTS t_ims_sales_transaction_tax;
CREATE TABLE t_ims_sales_transaction_tax(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_sales_transaction_tax_KEY1 ON t_ims_sales_transaction_tax(lot_number);

DROP TABLE IF EXISTS t_ims_sales_transaction_tender;
CREATE TABLE t_ims_sales_transaction_tender(
 sales_transaction_id varchar(30) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_sales_transaction_tender_KEY1 ON t_ims_sales_transaction_tender(lot_number);

DROP TABLE IF EXISTS t_ims_pay_off_data;
CREATE TABLE t_ims_pay_off_data(
 lot_number varchar(22) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_ims_pay_off_data_KEY1 ON t_ims_pay_off_data(lot_number);

DROP TABLE IF EXISTS m_error_notification_pattern;
CREATE TABLE m_error_notification_pattern(
...
DROP TABLE IF EXISTS m_error_notification_message;
CREATE TABLE m_error_notification_message(
...
DROP TABLE IF EXISTS t_jobnet_parameter;
CREATE TABLE t_jobnet_parameter(
...
DROP TABLE IF EXISTS m_trans_business_code;
CREATE TABLE m_trans_business_code(
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX m_trans_business_code_KEY1 ON m_trans_business_code(system_brand_code);

DROP TABLE IF EXISTS m_business_country_state_setting;
CREATE TABLE m_business_country_state_setting(
 system_brand_code varchar(4) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
...
DROP TABLE IF EXISTS m_store_control;
CREATE TABLE m_store_control(
 store_code varchar(10) NOT NULL,
 system_brand_code varchar(4) NOT NULL,
 system_business_code varchar(10),
 system_country_code varchar(3) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_transaction_discount;
CREATE TABLE t_sales_transaction_discount(
...
DROP TABLE IF EXISTS t_sales_transaction_detail;
CREATE TABLE t_sales_transaction_detail(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_sales_transaction_detail_KEY1 ON t_sales_transaction_detail(sales_transaction_id,detail_sub_number);

DROP TABLE IF EXISTS t_sales_transaction_detail_info;
CREATE TABLE t_sales_transaction_detail_info(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 item_detail_sub_number numeric(4),
...
DROP TABLE IF EXISTS t_sales_transaction_error_detail;
CREATE TABLE t_sales_transaction_error_detail(
...
DROP TABLE IF EXISTS t_sales_transaction_header;
CREATE TABLE t_sales_transaction_header(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 sales_transaction_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_sales_transaction_header_KEY1 ON t_sales_transaction_header(sales_transaction_id);

DROP TABLE IF EXISTS t_sales_transaction_total_amount;
CREATE TABLE t_sales_transaction_total_amount(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_transaction_history;
CREATE TABLE t_sales_transaction_history(
...
DROP TABLE IF EXISTS t_sales_transaction_tender;
CREATE TABLE t_sales_transaction_tender(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_transaction_tender_info;
CREATE TABLE t_sales_transaction_tender_info(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
 tender_id varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_report_transaction_discount;
CREATE TABLE t_sales_report_transaction_discount(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 promotion_type varchar(4) NOT NULL,
 promotion_no varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_report_transaction_detail;
CREATE TABLE t_sales_report_transaction_detail(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 item_detail_sub_number numeric(4) NOT NULL,
 sales_transaction_type varchar(6),
...
DROP TABLE IF EXISTS t_sales_report_transaction_detail_info;
CREATE TABLE t_sales_report_transaction_detail_info(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 item_detail_sub_number numeric(4) NOT NULL,
 key_code varchar(20),
...
DROP TABLE IF EXISTS t_sales_report_transaction_header;
CREATE TABLE t_sales_report_transaction_header(
 sales_transaction_id varchar(30) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 sales_transaction_sub_number numeric(4) NOT NULL,
 store_code varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_report_transaction_total_amount;
CREATE TABLE t_sales_report_transaction_total_amount(
 sales_transaction_id varchar(30) NOT NULL,
 total_type varchar(50) NOT NULL,
 total_amount_sub_number numeric(4) NOT NULL,
 total_amount_tax_excluded_currency_code varchar(3),
...
DROP TABLE IF EXISTS t_sales_report_transaction_tender;
CREATE TABLE t_sales_report_transaction_tender(
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(6) NOT NULL,
 tender_id numeric(6) NOT NULL,
 tender_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_report_transaction_tender_info;
CREATE TABLE t_sales_report_transaction_tender_info(
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(6) NOT NULL,
 tender_id numeric(6) NOT NULL,
 discount_value_currency_code varchar(3),
...
DROP TABLE IF EXISTS t_sales_report_transaction_order_information;
CREATE TABLE t_sales_report_transaction_order_information(
 integrated_order_id varchar(27) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_report_transaction_tax;
CREATE TABLE t_sales_report_transaction_tax(
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_discount;
CREATE TABLE t_sales_error_sales_transaction_discount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_detail;
CREATE TABLE t_sales_error_sales_transaction_detail(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_detail_info;
CREATE TABLE t_sales_error_sales_transaction_detail_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_header;
CREATE TABLE t_sales_error_sales_transaction_header(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 integrated_order_id varchar(27),
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_total_amount;
CREATE TABLE t_sales_error_sales_transaction_total_amount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 total_type varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_tender;
CREATE TABLE t_sales_error_sales_transaction_tender(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_tender_info;
CREATE TABLE t_sales_error_sales_transaction_tender_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_error_sales_order_information;
CREATE TABLE t_sales_error_sales_order_information(
 transaction_id varchar(57) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 order_barcode_number varchar(23),
 store_code varchar(10),
...
DROP TABLE IF EXISTS t_sales_error_sales_transaction_tax;
CREATE TABLE t_sales_error_sales_transaction_tax(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_discount;
CREATE TABLE t_error_evacuation_sales_transaction_discount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_discount_KEY1 ON t_error_evacuation_sales_transaction_discount(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_detail;
CREATE TABLE t_error_evacuation_sales_transaction_detail(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_detail_KEY1 ON t_error_evacuation_sales_transaction_detail(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_detail_info;
CREATE TABLE t_error_evacuation_sales_transaction_detail_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_detail_info_KEY1 ON t_error_evacuation_sales_transaction_detail_info(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_header;
CREATE TABLE t_error_evacuation_sales_transaction_header(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 sales_transaction_error_id varchar(57),
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_header_KEY1 ON t_error_evacuation_sales_transaction_header(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_total_amount;
CREATE TABLE t_error_evacuation_sales_transaction_total_amount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 total_type varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_total_amount_KEY1 ON t_error_evacuation_sales_transaction_total_amount(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_tender;
CREATE TABLE t_error_evacuation_sales_transaction_tender(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_tender_KEY1 ON t_error_evacuation_sales_transaction_tender(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_tender_info;
CREATE TABLE t_error_evacuation_sales_transaction_tender_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_tender_info_KEY1 ON t_error_evacuation_sales_transaction_tender_info(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_order_information;
CREATE TABLE t_error_evacuation_sales_order_information(
 transaction_id varchar(57) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 sales_transaction_error_id varchar(57),
 order_barcode_number varchar(23),
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_order_information_KEY1 ON t_error_evacuation_sales_order_information(sales_transaction_error_id);

DROP TABLE IF EXISTS t_error_evacuation_sales_transaction_tax;
CREATE TABLE t_error_evacuation_sales_transaction_tax(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_error_evacuation_sales_transaction_tax_KEY1 ON t_error_evacuation_sales_transaction_tax(sales_transaction_error_id);

DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_discount;
CREATE TABLE t_transaction_inquiry_sales_transaction_discount(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 promotion_type varchar(4) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_detail;
CREATE TABLE t_transaction_inquiry_sales_transaction_detail(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 item_detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_transaction_inquiry_sales_transaction_detail_KEY1 ON t_transaction_inquiry_sales_transaction_detail(sales_transaction_id,detail_sub_number);

DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_detail_info;
CREATE TABLE t_transaction_inquiry_sales_transaction_detail_info(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 item_detail_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_header;
CREATE TABLE t_transaction_inquiry_sales_transaction_header(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 sales_transaction_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_transaction_inquiry_sales_transaction_header_KEY1 ON t_transaction_inquiry_sales_transaction_header(sales_transaction_id);

DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_total_amount;
CREATE TABLE t_transaction_inquiry_sales_transaction_total_amount(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 total_type varchar(50) NOT NULL,
 total_amount_sub_number numeric(4) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_tender;
CREATE TABLE t_transaction_inquiry_sales_transaction_tender(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
 tender_id varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_tender_info;
CREATE TABLE t_transaction_inquiry_sales_transaction_tender_info(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
 tender_id varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_order_information;
CREATE TABLE t_transaction_inquiry_order_information(
 integrated_order_id varchar(27) NOT NULL,
 order_barcode_number varchar(23),
 store_code varchar(10) NOT NULL,
 system_brand_code varchar(4) NOT NULL,
...
DROP TABLE IF EXISTS t_transaction_inquiry_sales_transaction_tax;
CREATE TABLE t_transaction_inquiry_sales_transaction_tax(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 tax_group varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS m_trans_store_code;
CREATE TABLE m_trans_store_code(
 store_code varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_order_information;
CREATE TABLE t_sales_order_information(
 integrated_order_id varchar(27) NOT NULL,
 order_barcode_number varchar(23),
 store_code varchar(10) NOT NULL,
 system_brand_code varchar(4) NOT NULL,
...
DROP TABLE IF EXISTS t_sales_transaction_tax;
CREATE TABLE t_sales_transaction_tax(
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
 tax_group varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS t_pile_up_pay_off_data;
CREATE TABLE t_pile_up_pay_off_data(
 store_code varchar(10) NOT NULL,
 payoff_date varchar(8) NOT NULL,
 payoff_type_code varchar(6) NOT NULL,
 payoff_type_sub_number_code varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS t_pay_off_data;
CREATE TABLE t_pay_off_data(
 store_code varchar(10) NOT NULL,
 payoff_date varchar(8) NOT NULL,
 payoff_type_code varchar(6) NOT NULL,
 payoff_type_sub_number_code varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS m_pay_off_summary_mapping;
CREATE TABLE m_pay_off_summary_mapping(
...
DROP TABLE IF EXISTS t_alteration_history_sales_transaction_discount;
CREATE TABLE t_alteration_history_sales_transaction_discount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_discount_KEY1 ON t_alteration_history_sales_transaction_discount(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_detail;
CREATE TABLE t_alteration_history_sales_transaction_detail(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_detail_KEY1 ON t_alteration_history_sales_transaction_detail(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_detail_info;
CREATE TABLE t_alteration_history_sales_transaction_detail_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_detail_info_KEY1 ON t_alteration_history_sales_transaction_detail_info(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_header;
CREATE TABLE t_alteration_history_sales_transaction_header(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 history_type numeric(1) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_header_KEY1 ON t_alteration_history_sales_transaction_header(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_total_amount;
CREATE TABLE t_alteration_history_sales_transaction_total_amount(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 total_type varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_total_amount_KEY1 ON t_alteration_history_sales_transaction_total_amount(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_tender;
CREATE TABLE t_alteration_history_sales_transaction_tender(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_tender_KEY1 ON t_alteration_history_sales_transaction_tender(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_tender_info;
CREATE TABLE t_alteration_history_sales_transaction_tender_info(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 tender_group varchar(50) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_tender_info_KEY1 ON t_alteration_history_sales_transaction_tender_info(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_order_information;
CREATE TABLE t_alteration_history_order_information(
 transaction_id varchar(57) NOT NULL,
 integrated_order_id varchar(27) NOT NULL,
 history_type numeric(1) NOT NULL,
 sales_transaction_error_id varchar(57),
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_order_information_KEY1 ON t_alteration_history_order_information(sales_transaction_error_id);

DROP TABLE IF EXISTS t_alteration_history_sales_transaction_tax;
CREATE TABLE t_alteration_history_sales_transaction_tax(
 transaction_id varchar(57) NOT NULL,
 order_sub_number numeric(4) NOT NULL,
 sales_transaction_id varchar(30) NOT NULL,
 detail_sub_number numeric(4) NOT NULL,
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX t_alteration_history_sales_transaction_tax_KEY1 ON t_alteration_history_sales_transaction_tax(sales_transaction_error_id);

DROP TABLE IF EXISTS m_tender;
CREATE TABLE m_tender(
 store_code varchar(10) NOT NULL,
 tender_id varchar(50) NOT NULL,
