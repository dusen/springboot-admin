...
@SpringBootTest
@Transactional
public class InsertErrorServiceTest {

    @SpyBean
    InsertErrorService insertErrorTableService;
    ...
    public void testSuccess() throws Exception {
        when(salesErrorSalesOrderInformationEntityMapper
                .insertSelective(any(SalesErrorSalesOrderInformation.class))).thenReturn(1);
        when(salesErrorSalesTransactionHeaderEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionHeader.class))).thenReturn(1);
        when(salesErrorSalesTransactionDetailEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionDetail.class))).thenReturn(1);
        when(salesErrorSalesTransactionDetailInfoEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionDetailInfo.class))).thenReturn(1);
        when(salesErrorSalesTransactionDiscountEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionDiscount.class))).thenReturn(1);
        when(salesErrorSalesTransactionTaxEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionTax.class))).thenReturn(1);
        when(salesErrorSalesTransactionTenderEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionTender.class))).thenReturn(1);
        when(salesErrorSalesTransactionTenderInfoEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionTenderInfo.class))).thenReturn(1);
        when(salesErrorSalesTransactionTotalAmountEntityMapper
                .insertSelective(any(SalesErrorSalesTransactionTotalAmount.class))).thenReturn(1);

        when(errorTableDataConverter.convertTSalesErrorOrderInformationEntityForInsert(
                transactionImportData, userId, salesTransactionErrorId))
                        .thenReturn(new SalesErrorSalesOrderInformation());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionHeaderEntityForInsert(
                any(Transaction.class), anyString(), anyString(), anyInt()))
                        .thenReturn(new SalesErrorSalesTransactionHeader());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionDetailEntityForInsert(
                any(TransactionItemDetail.class), anyString(), anyInt(), anyString(), anyString(),
                anyInt(), anyInt())).thenReturn(new SalesErrorSalesTransactionDetail());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionDetailEntityForInsertOutside(
                any(NonItemDetail.class), anyString(), anyInt(), anyString(), anyString(),
                anyString(), anyInt(), anyInt()))
                        .thenReturn(new SalesErrorSalesTransactionDetail());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionDetailInfoEntityForInsert(
                any(NonItemInfo.class), anyString(), anyInt(), anyString(), anyString(), anyInt(),
                anyInt())).thenReturn(new SalesErrorSalesTransactionDetailInfo());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionTenderEntityForInsert(
                any(SalesTransactionTender.class), anyString(), anyInt(), anyString(), anyString(),
                anyInt())).thenReturn(new SalesErrorSalesTransactionTender());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionTenderInfoEntityForInsert(
                any(TenderInfo.class), anyString(), anyInt(), anyString(), anyString(), anyString(),
                anyString(), anyInt())).thenReturn(new SalesErrorSalesTransactionTenderInfo());
        when(errorTableDataConverter
                .convertTSalesErrorSalesTransactionTaxEntityForInsertTransaction(
                        any(SalesTransactionTaxDetail.class), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt()))
                                .thenReturn(new SalesErrorSalesTransactionTax());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionTotalAmountEntityForInsert(
                any(SalesTransactionTotal.class), anyString(), anyInt(), anyString(), anyString(),
                anyInt())).thenReturn(new SalesErrorSalesTransactionTotalAmount());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionDiscountEntityForInsertNon(
                any(NonItemDiscountDetail.class), anyString(), anyInt(), anyString(), anyString(),
                anyInt(), anyInt())).thenReturn(new SalesErrorSalesTransactionDiscount());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionTaxEntityForInsertNon(
                any(NonItemTaxDetail.class), anyString(), anyInt(), anyString(), anyString(),
                anyInt(), anyInt())).thenReturn(new SalesErrorSalesTransactionTax());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionDiscountEntityForInsert(
                any(ItemDiscount.class), anyString(), anyInt(), anyString(), anyString(), anyInt(),
                anyInt())).thenReturn(new SalesErrorSalesTransactionDiscount());
        when(errorTableDataConverter.convertTSalesErrorSalesTransactionTaxEntityForInsert(
                any(ItemTaxDetail.class), anyString(), anyInt(), anyString(), anyString(), anyInt(),
                anyInt())).thenReturn(new SalesErrorSalesTransactionTax());

        insertErrorTableService.insertErrorTable(transactionImportData, salesTransactionErrorId,
                userId);
        ...
        verify(errorTableDataConverter, times(1)).convertTSalesErrorOrderInformationEntityForInsert(
                transactionImportData, userId, salesTransactionErrorId);
        verify(errorTableDataConverter, times(transactionImportData.getTransactionList().size()))
                .convertTSalesErrorSalesTransactionHeaderEntityForInsert(
                        transactionArgumentCaptor.capture(), anyString(), anyString(), anyInt());
        verify(errorTableDataConverter,
                ...
                }).sum())).convertTSalesErrorSalesTransactionDetailEntityForInsert(
                        transactionItemDetailArgumentCaptor.capture(), anyString(), anyInt(),
        ...
        verify(errorTableDataConverter,
                ...
                }).sum())).convertTSalesErrorSalesTransactionDetailEntityForInsertOutside(
                        nonItemDetailArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                ...
                }).sum())).convertTSalesErrorSalesTransactionDetailInfoEntityForInsert(
                        nonItemInfoArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getSalesTransactionTenderList().size();
                }).sum())).convertTSalesErrorSalesTransactionTenderEntityForInsert(
                        salesTransactionTenderArgumentCaptor.capture(), anyString(), anyInt(),
        ...
        verify(errorTableDataConverter,
                ...
                }).sum())).convertTSalesErrorSalesTransactionTenderInfoEntityForInsert(
                        tenderInfoArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyString(), anyString(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getSalesTransactionTaxDetailList().size();
                }).sum())).convertTSalesErrorSalesTransactionTaxEntityForInsertTransaction(
                        salesTransactionTaxDetailArgumentCaptor.capture(), anyString(), anyInt(),
                        anyString(), anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getSalesTransactionTotalList().size();
                }).sum())).convertTSalesErrorSalesTransactionTotalAmountEntityForInsert(
                        salesTransactionTotalArgumentCaptor.capture(), anyString(), anyInt(),
                        anyString(), anyString(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getTransactionItemDetailList().stream().mapToInt(itemDetail -> {
                ...
                }).sum())).convertTSalesErrorSalesTransactionDiscountEntityForInsertNon(
                        nonItemDiscountDetailArgumentCaptor.capture(), anyString(), anyInt(),
                        anyString(), anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getTransactionItemDetailList().stream().mapToInt(itemDetail -> {
                ...
                }).sum())).convertTSalesErrorSalesTransactionTaxEntityForInsertNon(
                        nonItemTaxDetailArgumentCaptor.capture(), anyString(), anyInt(),
                        anyString(), anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getTransactionItemDetailList().stream().mapToInt(itemDetail -> {
                ...
                }).sum())).convertTSalesErrorSalesTransactionDiscountEntityForInsert(
                        itemDiscountArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter,
                times(transactionImportData.getTransactionList().stream().mapToInt(tran -> {
                    return tran.getTransactionItemDetailList().stream().mapToInt(itemDetail -> {
                ...
                }).sum())).convertTSalesErrorSalesTransactionTaxEntityForInsert(
                        itemTaxDetailArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt());
    ...
    @Test
    public void testTransactionEmpty() throws Exception {
        ...
        verify(errorTableDataConverter, times(0))
                .convertTSalesErrorSalesTransactionTaxEntityForInsertNon(
                        ...
                        anyString(), anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter, times(0))
                .convertTSalesErrorSalesTransactionDiscountEntityForInsert(
                        itemDiscountArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt());
        verify(errorTableDataConverter, times(0))
                .convertTSalesErrorSalesTransactionTaxEntityForInsert(
                        itemTaxDetailArgumentCaptor.capture(), anyString(), anyInt(), anyString(),
                        anyString(), anyInt(), anyInt());
    }
    ...
    @Test
    public void testEmptyInItemDetail() throws Exception {
        transactionImportData.getTransactionList().forEach(transaction -> {
            transaction.getTransactionItemDetailList().forEach(item -> {
                item.setItemDiscountList(new ArrayList<>());
                item.setItemTaxDetailList(new ArrayList<>());
                item.setNonItemDetailListByItem(null);
            });
    ...
    @Test
    public void testEmptyNonItemInItemDetail() throws Exception {
        transactionImportData.getTransactionList().forEach(transaction -> {
            transaction.getTransactionItemDetailList().forEach(item -> {
