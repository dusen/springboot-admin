DROP TABLE IF EXISTS public.m_general_delete_setting CASCADE;
CREATE TABLE public.m_general_delete_setting(
...
WITH (OIDS=FALSE,FILLFACTOR=90)
;
 CREATE INDEX m_trans_tender_KEY1 ON public.m_trans_tender(store_code,tender_id);
...
CREATE TABLE public.t_store_hourly_sku_result(
 ...
 update_program_id varchar(30),
  CONSTRAINT t_store_hourly_sku_result_pk
   PRIMARY KEY(store_code,business_date,time_local,sku_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.t_store_hourly_gather_result(
 ...
 business_date varchar(8) NOT NULL,
 time_local varchar(4) NOT NULL,
 gather_code numeric(8) NOT NULL,
 tran_create_date varchar(8),
 time_utc varchar(4),
 sales_hour numeric(2),
 sales_quantity_code varchar(1),
 ...
 update_program_id varchar(30),
  CONSTRAINT t_store_hourly_gather_result_pk
   PRIMARY KEY(store_code,business_date,time_local,gather_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.t_store_sku_result(
 ...
 initial_selling_price numeric(20),
 initial_selling_price_currency_code varchar(3),
 ...
 previcus_day_stock_quantity numeric(16),
 current_stock_quantity numeric(16),
 expected_delivery_quantity numeric(16),
 sales_result_amount_of_money_code varchar(1),
 sales_result_amount_of_money numeric(24),
 sales_result_currency_code varchar(3),
 sales_quantity_code varchar(1),
 sales_quantity numeric(16),
 create_user_id varchar(30),
 create_datetime timestamptz,
 ...
 update_program_id varchar(30),
  CONSTRAINT t_store_sku_result_pk
   PRIMARY KEY(store_code,business_date,sku_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.t_store_gather_result(
 ...
 update_program_id varchar(30),
  CONSTRAINT t_store_gather_result_pk
   PRIMARY KEY(store_code,business_date,gather_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE  public.t_store_hourly_two_digit_category_result(
 ...
 system_business_code varchar(10),
 system_country_code varchar(3) NOT NULL,
 eai_update_datetime timestamptz,
 eai_update_type varchar(1),
 eai_send_status varchar(1),
 eai_send_datetime varchar(1),
 tran_create_date varchar(8),
 time_utc varchar(4),
 sales_hour varchar(2),
...
CREATE TABLE public.t_transaction_inquiry_sales_transaction_header(
 ...
 sales_transaction_discount_amount_rate numeric(24,4),
 token_code varchar(30),
 return_present_flag boolean NOT NULL,
 return_complete_flag boolean DEFAULT FALSE NOT NULL,
...
CREATE TABLE public.t_alteration_history_sales_transaction_tender_info(
 ...
 update_program_id varchar(30),
  CONSTRAINT t_alteration_history_sales_transaction_tender_info_pk
   PRIMARY KEY(transaction_id,order_sub_number,sales_transaction_id,tender_group,tender_id,tender_sub_number,history_type)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
DROP TABLE IF EXISTS public.w_transaction_status_time CASCADE;
CREATE TABLE public.w_transaction_status_time(
 transaction_status_time timestamptz NOT NULL
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;

DROP TABLE IF EXISTS public.t_business_receiver_status CASCADE;
CREATE TABLE public.t_business_receiver_status(
 transaction_id varchar(57) NOT NULL,
...
DROP TABLE IF EXISTS public.t_business_processor_status_p0 CASCADE;
CREATE TABLE public.t_business_processor_status_p0(
 transaction_id varchar(57) NOT NULL,
...
DROP TABLE IF EXISTS public.t_business_processor_status_p1 CASCADE;
CREATE TABLE public.t_business_processor_status_p1(
 transaction_id varchar(57) NOT NULL,
 business_process_name varchar(50) NOT NULL,
 create_date timestamptz NOT NULL,
 create_user varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS public.w_untreated_transaction CASCADE;
CREATE TABLE public.w_untreated_transaction(
 transaction_id varchar(57) NOT NULL,
 retry_count numeric(1) NOT NULL,
...
CREATE TABLE public.w_trans_store_code(
 ...
 view_store_code varchar(20) NOT NULL,
 ...
 batch_region numeric(2) NOT NULL,
 integrate_db_business_code varchar(3),
 store_device_rmvl_date timestamp,
...
CREATE TABLE public.w_g_class_link(
 ...
 lot_number varchar(22) NOT NULL,
  CONSTRAINT w_g_class_link_pk
   PRIMARY KEY(lot_number,major_category_code,class_code,major_category_2_code,system_brand_code,eai_update_datetime)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.w_plu(
 ...
 initial_selling_price numeric(7,2),
 bundle_mix_flag numeric(1),
 communication_code varchar(25),
 promotion_code varchar(10),
 bundle_promotion_code varchar(10),
 single_price numeric(7,2),
 tax_rate numeric(6,4),
 tax_threshold_flag numeric(2),
 tax_threshold_less_tax_rate numeric(6,4),
 tax_threshold numeric(7,2),
 create_user_id varchar(30),
 create_datetime timestamptz NOT NULL,
 create_program_id varchar(30),
 update_user_id varchar(30),
 ...
 update_program_id varchar(30),
  CONSTRAINT w_plu_pk
   PRIMARY KEY(lot_number,plu_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.w_skulist_child(
 ...
 main_item_flag varchar(1) NOT NULL,
 inner_pack_size numeric(16,4) NOT NULL,
 logical_deleted_flag varchar(1) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
 batch_region numeric(2) NOT NULL,
 lot_number varchar(22) NOT NULL,
  CONSTRAINT w_skulist_child_pk
   PRIMARY KEY(lot_number,system_business_code,system_country_code,skulist_code,item_code,eai_update_datetime)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.m_item(
 ...
 year_code varchar(4),
 view_year_code varchar(1),
 season_code varchar(6),
 sale_country_code varchar(3),
 color_code varchar(10),
 size_code varchar(10),
 pattern_length_code varchar(10),
 major_category_code varchar(4) NOT NULL,
 class_code varchar(4) NOT NULL,
 middle_category_code varchar(4) NOT NULL,
 level1_top_selling_item_code varchar(25),
 level2_top_selling_item_code varchar(25),
 item_level numeric(1) NOT NULL,
 transaction_level numeric(1) NOT NULL,
 pack_kind varchar(1) NOT NULL,
 simple_pack_kind varchar(1) NOT NULL,
 contains_inner_kind varchar(1) NOT NULL,
 available_sale_flag boolean DEFAULT FALSE NOT NULL,
 orderable_flag boolean DEFAULT FALSE NOT NULL,
 pack_type varchar(1),
 receive_unit varchar(1),
 assort_code varchar(4),
 cost_num numeric(3),
 initial_selling_price numeric(24,4),
 retail_zone_group_id numeric(4),
 internal_item_name varchar(250) NOT NULL,
 ...
 second_item_name varchar(250) NOT NULL,
 ...
 receive_type_code varchar(6) NOT NULL,
 supplier_code varchar(10) NOT NULL,
 stock_buying_cost numeric(24,4),
 batch_region numeric(2),
 system_business_code varchar(10),
 create_user_id varchar(30),
 create_datetime timestamptz NOT NULL,
 ...
 update_program_id varchar(30),
  CONSTRAINT m_item_pk
   PRIMARY KEY(system_country_code,system_brand_code,item_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.w_skulist_parent(
 ...
 middle_category_code varchar(4),
 initial_selling_price numeric(24,4),
 regular_item_flag varchar(1) NOT NULL,
 core_attribute_flag varchar(1) NOT NULL,
 defective_product_judge_quantity numeric(3),
 line_up_type_code varchar(6),
 investment_consolidation_type varchar(1),
 ...
 set_auto_update_flag varchar(1) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
 batch_region numeric(2) NOT NULL,
 uda_value numeric(5),
 lot_number varchar(22) NOT NULL,
  CONSTRAINT w_skulist_parent_pk
   PRIMARY KEY(lot_number,system_business_code,system_country_code,skulist_code,eai_update_datetime)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
CREATE TABLE public.w_item_hierarchy_major_category(
 ...
 lot_number varchar(22) NOT NULL,
  CONSTRAINT w_item_hierarchy_major_category_pk
   PRIMARY KEY(lot_number,major_category_code,eai_update_datetime)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;
...
DROP TABLE IF EXISTS public.m_daily_sales_report_item_setting CASCADE;
CREATE TABLE public.m_daily_sales_report_item_setting(
 system_brand_code varchar(4) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
 ...
 not_display_flag boolean DEFAULT FALSE NOT NULL,
 create_user_id varchar(30),
 create_datetime timestamptz NOT NULL,
 create_program_id varchar(30),
 update_user_id varchar(30),
 update_datetime timestamptz,
 update_program_id varchar(30),
  CONSTRAINT m_daily_sales_report_item_setting_pk
...
CREATE TABLE public.m_item(
 system_country_code varchar(3) NOT NULL,
 system_brand_code varchar(4) NOT NULL,
 skulist_code varchar(25) NOT NULL,
 view_item_code varchar(25),
 year_code varchar(4),
 view_year_code varchar(1),
 season_code varchar(1),
 ...
 update_program_id varchar(30),
  CONSTRAINT m_item_pk
   PRIMARY KEY(system_country_code,system_brand_code,skulist_code)
)
WITH (OIDS=FALSE,FILLFACTOR=90)
;

DROP TABLE IF EXISTS public.m_item_level_1 CASCADE;
CREATE TABLE public.m_item_level_1(
 system_brand_code varchar(10) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
 item_code varchar(25) NOT NULL,
...
DROP TABLE IF EXISTS public.m_item_pack CASCADE;
CREATE TABLE public.m_item_pack(
 system_brand_code varchar(10) NOT NULL,
 system_business_code varchar(10) NOT NULL,
 system_country_code varchar(3) NOT NULL,
 item_code varchar(25) NOT NULL,
