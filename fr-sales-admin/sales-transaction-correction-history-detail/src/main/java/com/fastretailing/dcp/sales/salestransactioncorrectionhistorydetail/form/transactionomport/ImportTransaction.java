...
public class ImportTransaction {
    ...
    /** Format data creation date time. */
    private String formatDataCreationDateTime;
    ...
    private String formatOrderCancellationDate;

    /** Format data creation business date. */
    @StringDate(patterns = "yyyy/MM/dd")
    private String formatDataCreationBusinessDate;
    ...
    private List<ImportTransactionItemDetail> transactionItemDetailList;

    /** Non item detail list. */
    @JsonProperty("non_item_detail_list")
    private List<ImportNonItemDetail> nonItemDetailList;
    ...
    private List<ImportSalesTransactionTender> salesTransactionTenderList;

    /** Sales transaction tender list. */
    @JsonProperty("sales_transaction_tax_detail_list")
    private List<ImportSalesTransactionTaxDetail> salesTransactionTaxDetailList;

    /** Sales transaction total list. */
    @JsonProperty("sales_transaction_total_list")
    @NotEmpty(groups = {Insert.class, Correction.class, PosInsert.class})
    private List<ImportSalesTransactionTotal> salesTransactionTotalList;
