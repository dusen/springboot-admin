/**
 * @(#)SalesTransactionErrorListTestForChrome.java
 *
...
/**
 * Test class of sales transaction error list screen for chrome.
 */
...
public class SalesTransactionErrorListTestForChrome extends SalesTransactionErrorListTest {
