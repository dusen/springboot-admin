/**
 * @(#)DeclareIrregularSettlementsApplication.java
 *
 *                                                 Copyright (c) 2018 Fast Retailing Corporation.
 */

package com.fastretailing.dcp.sales.declareirregularsettlements;
...
/**
 * Application for declare irregular settlements list.
 */
@SpringBootApplication
@ComponentScan(basePackages = {"com.fastretailing.dcp.storecommon",
        "com.fastretailing.dcp.common.util",
        "com.fastretailing.dcp.sales.declareirregularsettlements",
...
public class DeclareIrregularSettlementsApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(DeclareIrregularSettlementsApplication.class, args);
    }
}
