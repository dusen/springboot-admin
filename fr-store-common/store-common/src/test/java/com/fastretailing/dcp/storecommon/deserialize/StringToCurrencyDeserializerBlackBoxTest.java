/**
 * @(#)StringToCurrencyDeserializerBlackBoxTest.java
 *
...
public class StringToCurrencyDeserializerBlackBoxTest {
    ...
    private static final String URL =
            StringUtils.join("/", BRAND, "/", REGION, "/", LANGUAGE, "/currencytest/");
    ...
    public void testNull() throws Exception {
        ...
        ResultActions res = mockMvc.perform(builder);
        res.andExpect(MockMvcResultMatchers.status().isOk());
        assertEquals("{\"currencyCode\":null}", res.andReturn().getResponse().getContentAsString());
    }
