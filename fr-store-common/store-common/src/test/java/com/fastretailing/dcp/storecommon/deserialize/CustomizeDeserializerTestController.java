/**
 * @(#)CustomizeDeserializerTestController.java
 *
 ...
 */
@RestController
@RequestMapping("/{brand}/{region}/{language}/transactions")
@Slf4j
public class CustomizeDeserializerTestController {
    ...
    public BooleanData post(@RequestBody @Validated BooleanData booleanData) {
        log.debug("server data={}", booleanData);
        return booleanData;
    }
