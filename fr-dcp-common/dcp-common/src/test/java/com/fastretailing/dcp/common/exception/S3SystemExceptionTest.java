...
@Slf4j
public class S3SystemExceptionTest {
    ...
    public void test1() throws Exception {
        ...
        S3SystemException exception = new S3SystemException(resultObject);
    ...
    public void test2() throws Exception {
        ...
        S3SystemException exception = new S3SystemException();
