/**
 * @(#)S3FileNotFoundExceptionTest.java
 *
...
@Slf4j
public class S3FileNotFoundExceptionTest {
    ...
    public void test1() throws Exception {
        ...
        S3FileNotFoundException exception = new S3FileNotFoundException(resultObject);
    ...
    public void test2() throws Exception {
        ...
        S3FileNotFoundException exception = new S3FileNotFoundException();
