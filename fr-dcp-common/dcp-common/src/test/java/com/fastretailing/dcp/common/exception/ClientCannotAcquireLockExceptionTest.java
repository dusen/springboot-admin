/**
 * @(#)ClientCannotAcquireLockExceptionTest.java
 *
...
@Slf4j
public class ClientCannotAcquireLockExceptionTest {
    ...
    public void test1() throws Exception {
        ...
        ClientCannotAcquireLockException exception = new ClientCannotAcquireLockException(resultObject, null);
