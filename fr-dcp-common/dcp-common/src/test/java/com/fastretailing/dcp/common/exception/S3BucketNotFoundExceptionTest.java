/**
 * @(#)S3BucketNotFoundExceptionTest.java
 *
...
@Slf4j
public class S3BucketNotFoundExceptionTest {
    ...
    public void test1() throws Exception {
        ...
        S3BucketNotFoundException exception = new S3BucketNotFoundException(resultObject);
    ...
    public void test2() throws Exception {
        ...
        S3BucketNotFoundException exception = new S3BucketNotFoundException();
