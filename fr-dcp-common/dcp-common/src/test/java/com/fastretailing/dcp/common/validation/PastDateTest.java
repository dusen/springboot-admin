...
public class PastDateTest {
    ...
    private static PastDateValidator validator;
    ...
    @Autowired
    private CommonUtility commonUtilityBean;
    ...
    public void validForm() throws Exception {
        ReflectionTestUtils.setField(validator, "commonUtility", commonUtilityBean);

        DateFormatterForm dateFormatterForm = new DateFormatterForm();
//        dateFormatterForm.setDateTime(LocalDateTime.parse("1999-07-07T00:00:00.000"));
