/**
 * @(#)NoAuthenticationExceptionTest.java
 *
...
@Slf4j
public class NoAuthenticationExceptionTest {
    ...
    public void test1() throws Exception {
        ...
        NoAuthenticationException exception = new NoAuthenticationException(resultObject);
