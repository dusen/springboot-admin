...
/**
 * TestBase for Domain Layer with embedded KAFKA server.<br>
 *
 * @author Fast Retailing
 * @version $Revision$
 */
public class OmsKafkaDomainTestBase extends OmsDomainTestBase {
    ...
    protected <T> List<T> getRecords(Class<T> recordType) throws IOException {
        ...
        for (ConsumerRecord<String, String> record : records) {
            result.add(JsonUtility.toObject(record.value(), recordType));
        }
        consumer.commitSync();
        return result;
    }
